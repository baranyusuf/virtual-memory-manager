 ...
 */
VMStatus vm_page_write(int pid, void* virtual_addr, const void* write_data, size_t size);
 ...
 */
VMStatus vm_page_read( int pid, void* virtual_addr,       void* read_buffer,  size_t size);
